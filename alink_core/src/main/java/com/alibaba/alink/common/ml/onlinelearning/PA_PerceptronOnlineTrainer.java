...
public class PA_PerceptronOnlineTrainer extends PerceptronBaseTrainer {

    public PA_PerceptronOnlineTrainer(List <Row> modelRows, TableSchema dataSchema, AlinkParameter params) {
    ...
    public double calTau(Vector features, double target, double pred, double C) {
        ...
        return sufferLoss / features.l2normSquare();
    }
}
