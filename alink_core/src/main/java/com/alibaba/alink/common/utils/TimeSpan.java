...
public class TimeSpan {
    ...
    public String toString() {
        ...
        if (m_days > 0) {
            r += Long.toString(m_days) + " days  ";
        }
        if (bStart || m_hours > 0) {
            r += Integer.toString(m_hours) + " hours  ";
        }
        if (bStart || m_minutes > 0) {
            r += Integer.toString(m_minutes) + " minutes  ";
        }
        if (bStart || m_seconds > 0) {
            r += Integer.toString(m_seconds) + " seconds  ";
        }
        return r + Double.toString(m_milliseconds) + " milliseconds.";
    }
