...
public class JDBCUpserOutputFormat extends RichOutputFormat<Tuple2<Boolean, Row>> {
    ...
    public JDBCUpserOutputFormat(String username, String password, String drivername, String dbURL, String tableName, String[] primaryColNames) {
    ...
    private String getUpdataSql(Row row) {
        ...
        for (int i = 1; i < primaryColNames.length; i++) {
            idx = TableUtil.findIndexFromName(colNames, this.primaryColNames[i]);
            sb.append(" and  ").
