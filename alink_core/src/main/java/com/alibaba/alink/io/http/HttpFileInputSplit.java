...
public class HttpFileInputSplit implements InputSplit {
    ...
    private static long BUFFER_SIZE = 1024L * 1024L;
    ...
    public HttpFileInputSplit(String path, int numSplits, int splitNo, boolean splitable, long contentLength, String etag) {
        this.path = path;
