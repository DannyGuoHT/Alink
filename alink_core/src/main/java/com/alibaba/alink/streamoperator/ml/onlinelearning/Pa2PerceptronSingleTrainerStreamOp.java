...
public class Pa2PerceptronSingleTrainerStreamOp extends SingleOnlineTrainerStreamOp {

    public Pa2PerceptronSingleTrainerStreamOp(BatchOperator model, String[] featureColNames, String labelColName, String predResultColName, double C) throws Exception {
